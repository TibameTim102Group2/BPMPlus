...
namespace BPMPlus.Data.Migrations
{
    ...
    [Migration("20240825055522_Change Employee Id to uniqe")]
    partial class ChangeEmployeeIdtouniqe
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FunctionGroup", b =>
                {
                    b.Property<string>("FunctionsFunctionId")
                        .HasColumnType("VARCHAR(20)");

                    b.Property<string>("GroupsGroupId")
                        .HasColumnType("VARCHAR(20)");

                    b.HasKey("FunctionsFunctionId", "GroupsGroupId");
            ...
            modelBuilder.Entity("FunctionGroup", b =>
                {
                    b.HasOne("BPMPlus.Models.Function", null)
                        .WithMany()
                        .HasForeignKey("FunctionsFunctionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BPMPlus.Models.Group", null)
                        .WithMany()
