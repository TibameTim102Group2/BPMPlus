...
{
    public class EmailService : AesEncryptionService
    {
        //時間戳記
        public long GetTimeStamp()
        {
            var utcNow = DateTimeOffset.UtcNow;
            var unixTimeStamp = utcNow.ToUnixTimeSeconds();
        ...
        public DateTime TimestampToDateTime(long unixTimeStamp)
        {
            ...
            Console.WriteLine(localDateTime.ToString("yyyy/MM/dd HH:mm:ss:ffff"));
